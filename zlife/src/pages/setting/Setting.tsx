  ...
  return (
    <PageLayout>
      <div className="flex flex-col gap-4">
        ...
        <div className="bg-background-secondary p-4 rounded-full flex justify-between items-center">
        ...
        <div className="bg-background-secondary p-4 rounded-full flex justify-between items-center">
          ...
          <div className="flex items-center relative justify-cente gap-4">
            ...
            />
            <div
              className={`absolute flex bottom-[-13px] w-[40px] justify-between left-1 ${
