...
export const inputClass =
  "2xl:text-base text-sm bg-white rounded-3xl placeholder:text-sm !outline-none block w-full 2xl:py-[8px] py-2 px-3 border border-secondary-500 focus:border-primary disabled:opacity-70 disabled:cursor-not-allowed disabled:bg-secondary-200";
