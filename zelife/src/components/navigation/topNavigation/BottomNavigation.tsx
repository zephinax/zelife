...
export default function BottomNavigation() {
  ...
  return (
    <div className="py-2 px-2.5 fixed w-full bottom-0">
      <div
        dir="ltr"
        className={`h-[68px] py-5 w-full max-w-5xl mx-auto gap-4 border-background border-[1px] bg-background-secondary/40 backdrop-blur-sm items-center flex justify-evenly
